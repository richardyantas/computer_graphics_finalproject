...
#define TERRAIN1D_DEFAULT_MIN_LENGTH    8.0f
#define TERRAIN1D_DEFAULT_MAX_LENGTH    15.0f
#define TERRAIN1D_DEFAULT_DEPTH         2.0f
#define TERRAIN1D_DEFAULT_MIN_BUMPS     3
#define TERRAIN1D_DEFAULT_MAX_BUMPS     7
#define TERRAIN1D_DEFAULT_MIN_HEIGHT    2
#define TERRAIN1D_DEFAULT_MAX_HEIGHT    6
