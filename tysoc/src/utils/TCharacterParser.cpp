...
namespace tysoc
{
    ...
    bool TCharacterParser::parseCharacter( TCharacterNode& tree, const string& charFileName )
    {
        ...
        ifstream _fStream( _fullCharFileName );
  ...
  //      bool _succ = json::parse( _strJson, _root );
  ...
  //      if ( _succ )
  //      {
  //          if ( _root.find( "Skeleton" ) != _root.end() )
  //          {
  ...
  //      }
    ...
    bool TCharacterParser::_loadSkeleton( TCharacterNode& tree, const json& root )
    {
    ...
    bool TCharacterParser::_parseJoints( vector< TCharacterNodeData >& dataResources, const json& rootJoints )
    {
    ...
    bool TCharacterParser::_parseShapes( vector< TCharacterNodeData >& dataResources, const json& rootShapes )
    {
    ...
    bool TCharacterParser::_parseGraphics( vector< TCharacterNodeData >& dataResources, const json& rootGraphics )
    {
    ...
    bool TCharacterParser::_parsePDCdata( vector< TCharacterNodeData >& dataResources, const json& rootPDC )
    {
        return true;
    }
